...
static const Key keys[] = {
    ...
    //+1 }
    //}, 	{ MODKEY,                       XK_minus,  setgaps,        {.i =
    //-1 }
    //}, 	{ MODKEY,                       XK_equal,  setgaps,        {.i =
    //+1 }
...
static const Button buttons[] = {
    ...
    //{.v = &layouts[2]} }, 	{ ClkWinTitle,          0,              Button2,
    // zoom,           {0} }, 	{ ClkStatusText,        0, Button2, spawn, {.v
    //= termcmd } },
    ...
    //{0} }, 	{ ClkTagBar,            0,              Button3, toggleview,
    //{0} }, 	{ ClkTagBar,            MODKEY,         Button1,        tag,
    //{0} }, 	{ ClkTagBar,            MODKEY,         Button3, toggletag, {0}
    //},
};
